...
class DeepLite(object):
    ...
    def __init__(self, target, nlayer=3, nneuron=30,
                    ...
                    npoint=300, ntrain=300, nvalid=300, points_type="fixed",
                    step_size=1e-2, niter=None, patience=None,
                    gpu_count=1
                    ):        
    ...
    def build_model(self, gpu_count=1):
        ...
        kn.npoint = npoint
        loss, score, _, _, r_norm, l_norm, curve, w_norm, k_loss, _ = \
        ...
        sc         = kn.individual_score(test_data, alpha=self.alpha)
        self.ops["hv"] = hv
        self.ops["gv"] = gv
        self.ops["fv"] = fv
        self.ops["sc"] = sc
    ...
    def default_file_name(self):
        ...
        file_name = "%s_D%02d_l%d_nd%d_np%d_nt%d_nv%d_pt%s_ss%d_ni%d_n%02d_k%d_m%d_b%d_p%d_nk%d" % \
