...
import step_strategies as ss
import data_streams as ds
import util
...
class SGD:
    ...
    def train(self, minibatch=None, tol=None, maxepochs=None, monitor_every=None, patience=None, verbose=False, show_progress=False, val_in_same_plot=True):
        """
        Trains the model.
