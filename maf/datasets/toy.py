...
class TOY:
    ...
    def __init__(self, name, D, N=10000, noise_std=0.0, seed=1, data_args={}, **kwargs):

        dist = RealToy(name, D, N=N, seed=seed, noise_std=0.0, ntest=1000, data_args=data_args, **kwargs)
